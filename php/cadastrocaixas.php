...
<header>
    ...
    <h2 class="title conta2">Cadastre a Caixa</h2>
            <form class="formrevista" method="post"  action="conexaocaixa.php">
                <input class="field" type="text" name="cor" placeholder="  Cor da Caixa">
                <input class="field" type="text" name="etiqueta" placeholder="  Etiqueta">
                <input class="field" type="number" name="numcaixa" placeholder="  Número da Caixa">
