...
$sth = $db->prepare('SELECT * FROM revista WHERE numero_edicao LIKE :numero_edicao');
$sth->bindParam(':numero_edicao',$edicao, PDO::PARAM_STR);
...
.table-bg{
    background-color: rgba(191,6,92,0.9);
...
<header>
    ...
    <br>
    <br>
    <a href="numeroedicao.php"><button class="btn-voltar" type="submit">Voltar</button></a>
    <br>
    <table class="table text-white table-bg">
    <div class="m-5">
      <thead>
          <tr>
              <th scope="col" name="n_edicao">Número da Edição</th>
      ...
      <tbody>
        <?php  
          if (count($resultados)){
            ...
            <?php
            echo "<tr>";
            echo "<td>".$Resultado['numero_edicao']."</td>";
